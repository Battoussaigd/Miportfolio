  ...
  es: {
    ...
    projects: {
      ...
      items: [
        ...
        { icon: <BookOpen className="w-8 h-8 text-cyan-400" />, name: "Pillanlelbún Digital 2026 (Suspendido)", desc: "Formación tecnológica para comunidad rural: Track Escolar, Impulso y Corazón. PWAs, IA y RAG.", tags: ["IA Generativa", "RAG", "PWA"], impact: "🌱 IA para zonas rurales · $0" },
        { icon: <Users className="w-8 h-8 text-cyan-400" />, name: "Líderes Digitales Lautaro (por confirmar)", desc: "3 tracks para dirigentes sociales: gestión con IA, inteligencia comunitaria y app de voz para personas con discapacidad.", tags: ["IA de Voz", "Accesibilidad", "Gems"], impact: "🎙️ Inclusión digital radical · $0" }
      ]
    },
    cchia: {
